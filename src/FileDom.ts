...
export class FileDom {
    ...
    private getParticleJs(): string {
        // 获取配置
        const config = this.workConfig;
        
        // 如果粒子效果未启用，则返回空字符串
        if (!config.get('particleEffect', false)) {
            return '';
        }
